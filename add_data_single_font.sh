...
trdg -c $1 -rs -let -num -w 1 -e png -k 15 -rk -obb 1 -m 0 -d 1 -b 0 -wd 160 -cs  -al 1 -ft trdg/fonts/latin/DroidSansMono-V4.ttf -f 60
popd
...
pushd TextRecognitionDataGenerator
trdg -c $2 -rs -let -num -w 1 -e png -k 15 -rk -obb 1 -m 0 -d 1 -b 0 -wd 160 -cs  -al 1 -ft trdg/fonts/latin/DroidSansMono-V4.ttf -f 60
popd
